...
const getFoodInfoByName = `SELECT total_emissions, total_water, landuse, farm, processing, transport, packing, retail, one_serving, serving_weight FROM foods WHERE foodname = $1`;
